...
const SubgestiuneDist2 = ({ user, ID, showSubgestiune, setShowSubgestiune, setShowPicker, setShowModal, gestiune }) => {
                ...
                <form onSubmit={handleAddFormSubmit}>
                    <div className="form-section">
                        <div className='readonly'>
                            ...
                            <div className='input-with-tooltip' title={"Acestă bucată nu are serie!"}>
                                <input
                                    className="input-outside-table"
                                    type="text"
                                    name="Serie"
                                    value={"Acestă bucată nu are serie!"}
                                    readOnly
                                />
                            </div>
                        </div>
...
export default SubgestiuneDist2