...
const StudentDest = ({ showStudent, setShowStudent, setShowDP, setDestinatar, setPostData }) => {
    ...
    const handleAddFormSubmit = async (event) => {
        ...
        if (userTest.fullName !== userTest.fullNameTest) {
            alert('Numele introdus nu aparține nici unui student!');
            return;
        }
